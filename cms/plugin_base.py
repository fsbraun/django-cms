...
class CMSPluginBase(admin.ModelAdmin, metaclass=CMSPluginBaseMetaclass):
    ...
    def render_close_frame(self, request, obj, add=None, extra_context=None):
        ...
        data['structure'], downcasted_plugins = get_plugin_tree(request, plugins)
    ...
    def response_add(self, request, obj, **kwargs):
        ...
        # like ckeditor.
        return self.render_close_frame(request, obj,  True)
    ...
    def response_change(self, request, obj):
        ...
        return self.render_close_frame(request, obj, False)
